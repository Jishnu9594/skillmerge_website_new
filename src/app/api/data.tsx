...
export const courses = [
  ...
  },
  {
    ...
    modules: [
      ...
      "Digital Forensic",
      "Malware Analysis",
      "Detecting Windows Attack with Splunk",
      "Security Incident Reporting",
      "Developing CRUD application and CTF machines",
      "Bug bounty and burp automation",
      "CTF’s",
      "AD and API level projects",
      "Building defending machines with ELK",
  ...
  },
  {
    ...
    modules: [
      ...
      "Report writing",
      "Implementing OWASP standard in testing",
      "Developing CRUD application and pentesting",
    ],
    careerOpportunities:
      "Penetration Tester,Ethical Hacker,Red Team Specialist,Vulnerability Analyst",
    certificate:
      "Industry-recognized Certificate in Ethical Hacking and Penetration Testing and Certificate of Completion recognized by industry professionals in cybersecurity.",
  },
  // {

          ...
          <div className="col-span-4 md:col-span-12 lg:col-span-4">
            ...
            <div className="flex items-center gap-4 mt-6">
              <Link
                ...
                className="hover:text-[#9b59b6] text-gray-400 text-3xl transition-colors"
              >
          ...
          <div className="col-span-2">
            ...
            <ul>
              {headerData.map((item, index) => (
                <li
                  key={index}
                  className="mb-2 text-gray-400 hover:text-[#9b59b6] w-fit transition-colors"
                >
          ...
          <div className="col-span-4 md:col-span-4 lg:col-span-4 space-y-8">
            <div className="flex items-center gap-2">
              <Icon
                ...
                className="text-[#9b59b6] text-3xl inline-block"
              />
            ...
            <div className="flex items-center gap-2">
              <Icon
                ...
                className="text-[#9b59b6] text-3xl inline-block"
              />
              <h5 className="text-lg text-gray-400">info@skillmerge.in</h5>
            </div>
          </div>
        </div>
        ...
        <div className="mt-10 lg:flex items-center justify-between text-gray-500 text-sm">
          <h4 className="text-center lg:text-left font-normal">
            ...
            <Link
              href="#"
              target="_blank"
              className="hover:text-[#9b59b6] transition-colors"
            >
              Expert's Skill Merge Hub PVT LTD
            </Link>
          </h4>
          <div className="flex gap-5 mt-5 lg:mt-0 justify-center lg:justify-start">
            <Link href="/" className="hover:text-[#9b59b6] transition-colors">
              Privacy policy
            </Link>
            <Link href="/" className="hover:text-[#9b59b6] transition-colors">
              Terms & conditions
